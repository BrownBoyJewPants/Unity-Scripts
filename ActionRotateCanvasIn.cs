...
public ActionRotateCanvasIn.ALIGN alignment;
...
[IteratorStateMachine(typeof(ActionRotateCanvasIn.<Execute>d__15))]
...
{ 
case ActionRotateCanvasIn.ALIGN.Top: 
this.animpanel.pivot = new Vector2(0f, 1f);
this.rotation = new Vector3(90f, 0f, 0f);
this.rotation1 = Quaternion.Euler(this.rotation);
goto IL_20B;
case ActionRotateCanvasIn.ALIGN.Bottom: 
this.animpanel.pivot = new Vector2(1f, 0f);
this.rotation = new Vector3(-90f, 0f, 0f);
this.rotation1 = Quaternion.Euler(this.rotation);
goto IL_2E2;
case ActionRotateCanvasIn.ALIGN.Left: 
this.animpanel.pivot = new Vector2(0f, 0.5f);
this.rotation = new Vector3(0f, 90f, 0f);
this.rotation1 = Quaternion.Euler(this.rotation);
goto IL_3B9;
case ActionRotateCanvasIn.ALIGN.Right: 
...
Quaternion identity;
this.animpanel.localRotation = Quaternion.Lerp(this.rotation1, identity, ease);
yield return null;
continue;
}
goto IL_4A4;
...
Quaternion identity;
this.animpanel.localRotation = Quaternion.Lerp(this.rotation1, identity, ease2);
yield return null;
continue;
}
goto IL_4A4;
...
Quaternion identity;
this.animpanel.localRotation = Quaternion.Lerp(this.rotation1, identity, ease3);
yield return null;
continue;
}
goto IL_4A4;
...
Quaternion identity;
this.animpanel.localRotation = Quaternion.Lerp(this.rotation1, identity, ease4);
yield return null;
continue;
}
IL_4A4:
