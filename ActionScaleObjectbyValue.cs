...
[IteratorStateMachine(typeof(ActionScaleObjectbyValue.<Execute>d__20))]
...
{ 
case 0: 
this.objectTransform = this.objecttoScale.GetComponent<Transform>();
this.objOrigPos = this.objectTransform.localScale;
this.originalValx = this.objectTransform.localScale.x;
this.originalValy = this.objectTransform.localScale.y;
this.originalValz = this.objectTransform.localScale.z;
if (this.xvalue)
{ 
...
this.objectTransform.localScale = Vector3.Lerp(this.objOrigPos, this.objNewPos, ease);
yield return null;
continue;
}
if (!this.returnTo)
...
this.objectTransform.localScale = Vector3.Lerp(this.objNewPos, this.objOrigPos, ease2);
yield return null;
continue;
}
goto IL_2CB;
